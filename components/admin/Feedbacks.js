...
const Feedbacks = ({ preset_product_id }) => {
    ...
    function getItems(e = null){
        ...
        feedbacksApi.index(form, (response) => {
            setItems(response.data);
        })
    }

    function destroy(){
        feedbacksApi.destroy(form, (response) => {
            setItems({
                ...items,
        ...
        <div className="main-inner">
            <div className="page-top">
                <div className="fragment">
                    <h3 className="page-top-title">피드백 목록</h3>
                ...
                <div className="fragment">
                    <div className="m-spaces type01">
                        ...
                        <div className="m-space-wrap">
                            <div className="m-space">
                                <Link href={`/admin/feedbacks/create?preset_product_id=${preset_product_id}`} className="m-btn type01 bg-primary white">
                                    생성하기
                                </Link>
                            </div>
                        </div>
